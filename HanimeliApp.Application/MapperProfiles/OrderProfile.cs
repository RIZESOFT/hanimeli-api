...
public class OrderProfile : Profile
{
    public OrderProfile()
    {
        CreateMap<Order, OrderModel>()
            .ForMember(o => o.OrderItems, s => s.MapFrom((x, _) => x.OrderItems.GroupBy(oi => oi.MenuId).Select(oi =>
            {
                var orderItem = oi.First();
                return new OrderItemModel
                {
                    MenuId = orderItem.MenuId,
                    Menu = orderItem.Menu != null ? new MenuModel
                    {
                        ...
                        Beverages = orderItem.Menu.Beverages != null ? orderItem.Menu.Beverages.Select(b => new BeverageModel
                        {
                            Id = b.Id,
                            Name = b.Name,
                        ...
                        Foods = orderItem.Menu.Foods != null ? orderItem.Menu.Foods.Select(f => new FoodModel
                        {
                            Id = f.Id,
                            Name = f.Name,
                    ...
                    Cook = orderItem.Cook != null ? new CookModel
                    {
                    ...
                    Beverage = orderItem.Beverage != null ? new BeverageModel
                    {
                    ...
                    Food = orderItem.Food != null ? new FoodModel
                    {
